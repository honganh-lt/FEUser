...
const product2Api = {
    ...
    //
    const productList = await axiosClient.get('products2', {params: newParams});
    const count = await axiosClient.get('/products2/count', {params: newParams});
